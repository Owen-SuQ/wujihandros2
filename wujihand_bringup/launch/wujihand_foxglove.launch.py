...
Usage:
    ...
    ros2 launch wujihand_bringup wujihand_foxglove.launch.py hands:=347B38773433

    # Two hands with custom names
    ros2 launch wujihand_bringup wujihand_foxglove.launch.py hands:=left:SN1,right:SN2
"""
...
def launch_setup(context):
    ...
    # Foxglove Bridge node (only one instance needed)
    actions.append(
        Node(
