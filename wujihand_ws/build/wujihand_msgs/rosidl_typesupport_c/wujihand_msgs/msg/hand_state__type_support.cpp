...
static const _HandState_type_support_symbol_names_t _HandState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wujihand_msgs, msg, HandState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wujihand_msgs, msg, HandState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wujihand_msgs, msg, HandState)() {
  return &::wujihand_msgs::msg::rosidl_typesupport_c::HandState_message_type_support_handle;
}
